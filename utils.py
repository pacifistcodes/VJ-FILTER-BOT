...
async def send_all(bot, userid, files, ident, chat_id, user_name, query):
    ...
    try:
        if ENABLE_SHORTLINK:
            for file in files:
                ...
                if not await db.has_premium_access(userid) and SHORTLINK_MODE == True:
                    await bot.send_message(chat_id=userid, text=f"<b>ʜᴇʏ ᴛʜᴇʀᴇ {user_name} 👋🏽 \n\nsᴇᴄᴜʀᴇ ʟɪɴᴋ ᴛᴏ ʏᴏᴜʀ ғɪʟᴇ ʜᴀs sᴜᴄᴄᴇssғᴜʟʟʏ ʙᴇᴇɴ ɢᴇɴᴇʀᴀᴛᴇᴅ ᴘʟᴇᴀsᴇ ᴄʟɪᴄᴋ ᴅᴏᴡɴʟᴏᴀᴅ ʙᴜᴛᴛᴏɴ\n\n🗃️ ꜰɪʟᴇ ɴᴀᴍᴇ : {title}\n🔖 ꜰɪʟᴇ ꜱɪᴢᴇ : {size}</b>", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📤 ᴅᴏᴡɴʟᴏᴀᴅ 📥", url=await get_shortlink(chat_id, f"https://telegram.me/{temp.U_NAME}?start=files_{file.file_id}"))]]))
        else:
            for file in files:
        ...
        await query.answer('ʜᴇʏ, ꜱᴛᴀʀᴛ ʙᴏᴛ ꜰɪʀꜱᴛ ᴀɴᴅ ᴄʟɪᴄᴋ ꜱᴇɴᴅ ᴀʟʟ', show_alert=True)
    except Exception as e:
        await query.answer('ʜᴇʏ, ꜱᴛᴀʀᴛ ʙᴏᴛ ꜰɪʀꜱᴛ ᴀɴᴅ ᴄʟɪᴄᴋ ꜱᴇɴᴅ ᴀʟʟ', show_alert=True)
