    ...
    if message.chat.id == AUTH_CHANNEL and join_db().isActive():
        ...
        if data.split("-", 1)[0] == "VJ":
            ...
            if vj and PREMIUM_AND_REFERAL_MODE == True:
                ...
                m=await client.send_sticker(chat_id = message.from_user.id, sticker = "CAACAgUAAxkBAAECS1xm-wUgkay3GKsjzzn67dANCWjRaQACOAADUDKMFX91QKv3AAHFDR4E") 
